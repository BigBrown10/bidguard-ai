...
// Subtle animated background - darkened version
export function AnimatedBackground() {
    return (
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
            {/* Base gradient - very dark */}
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,#0a1020_0%,#030508_50%,#000000_100%)]" />
